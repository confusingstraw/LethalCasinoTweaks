...
This project has been bootstrapped from the [Lethal Company Mod Template](https://github.com/Distractic/LethalCompanyTemplate).
...
<!-- BepInEx Properties -->
<PropertyGroup>
    <AssemblyName>confusingus.LethalCasinoTweaks</AssemblyName>
    <Product>LethalCasinoTweaks</Product>
